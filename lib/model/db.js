...
const {copyAttribs, range, Reentrant, deepJSONCopy, promisify, Enum} =
  require('../util.js');
 ...
 */
class HelpTicketStatus extends Enum {
  /**
   * @param {String} name    the name of the enumeration
   */
  constructor(name) {
...
Enum.reg(
    new HelpTicketStatus('open'),
    new HelpTicketStatus('closed'),
    new HelpTicketStatus('resolved'));
...
let inst = null;
module.exports = {
  DBError, Database, DatabaseTransaction, ProjectStatus, HelpTicketStatus,
  getInst: () => inst,
  setInst: (i) => inst = i,
};
