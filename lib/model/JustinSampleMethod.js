...
($createUTDPerson)=>bind_param('iiii', $UID, $Utype, $NetID, $isAdmin);
...
//  Faculty Entity
// eslint-disable-next-line max-len
($createFaculty) = {$conn: ('INSERT INTO Faculty (UID, TID) VALUES (?, ?)')};
($createFaculty)=>bind_param('ii', $UID, $TID);

//  Student Entity
// eslint-disable-next-line max-len
($createStudent) = {$conn: ('INSERT INTO Student (UID, Major, Resume, Member_Of) VALUES (?, ?, ?, ?,)')};
($createStudent)=>bind_param('isbi', $UID, $Major, $Resume, $memberOf);
