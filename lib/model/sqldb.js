...
class SQLDatabase extends Database {
   ...
   * after whitelist filtering.
   * @param {Integer} pid    the id to search for.
   * @param {Object} changes   the attributes to be changed
   * and their new values
   * @return {Boolean} true if changed, false if no change occurred.
   */
  async alterSkillReqInfo(pid, changes) {
    ...
    return await this.alterEntity(skillReqWhiteList, pid, changes, 'SkillsReq',
        'pid');
  }
  /**
   ...
   * @param {Integer} teamID    the team id to search for.
   * @param {Object} changes   the attributes to be changed
   * and their new values
   * @return {Boolean} true if changed, false if no change occurred.
   */
  async alterFacultyOrTeamInfo(teamID, changes) {
    ...
    return await this.alterEntity(facultyOrTeamWhiteList, teamID, changes,
  ...
  async alterChoiceInfo(tid, changes) {
    ...
    return await this.alterEntity(choiceWhiteList, tid, changes, 'Choice',
        'tid');
  }
  /**
