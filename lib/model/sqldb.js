...
class SQLDatabase extends Database {
  ...
  async alterUserInfo(uid, changes) {
    const userWhiteList = ['fname', 'lname', 'email', 'address', 'isUTD',
      'isEmployee'];
    this.alterEntity(userWhiteList, uid, changes, 'Users', 'userId');
  }
  /**
  ...
  async alterSkillReqInfo(pid, changes) {
    ...
    this.alterEntity(skillReqWhiteList, pid, changes, 'SkillsReq', 'pid');
  }
  /**
  ...
  async alterProjInfo(projID, changes) {
    ...
    this.alterEntity(projWhiteList, projID, changes, 'Project', 'projID');
  }
  /**
  ...
  async alterUTDInfo(uid, changes) {
    ...
    this.alterEntity(utdWhiteList, uid, changes, 'UTDPersonnel', 'uid');
  }
  /**
  ...
  async alterFacultyInfo(fuid, changes) {
    ...
    this.alterEntity(facultyWhiteList, fuid, changes, 'Faculty', 'fuid');
  }
  /**
  ...
  async alterStudentInfo(suid, changes) {
    ...
    this.alterEntity(studentWhiteList, suid, changes, 'Student', 'suid');
  }
  /**
  ...
  async alterEmployeeInfo(euid, changes) {
    ...
    this.alterEntity(employeeWhiteList, euid, changes, 'Employee', 'euid');
  }
  /**
  ...
  async alterCompanyInfo(name, changes) {
    ...
    this.alterEntity(companyWhiteList, name, changes, 'Company', 'name');
  }
  /**
  ...
  async alterFacultyOrTeamInfo(teamID, changes) {
    ...
    this.alterEntity(facultyOrTeamWhiteList, teamID, changes,
  ...
  async alterTeamInfo(tid, changes) {
    ...
    this.alterEntity(teamWhiteList, tid, changes, 'Team', 'tid');
  }
  /**
  ...
  async alterChoiceInfo(tid, changes) {
    ...
    this.alterEntity(choiceWhiteList, tid, changes, 'Choice', 'tid');
  }
  /**
  ...
  async alterHelpTicketInfo(hid, changes) {
    ...
    this.alterEntity(helpTicketWhiteList, hid, changes, 'HelpTicket', 'hid');
  }
}
