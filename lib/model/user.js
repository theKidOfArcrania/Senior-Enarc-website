...
class Employee extends Uent {
   ...
   */
  async reload() {
    Object.assign(this, await getInst().loadEmployeeInfo(this.uid));
  }
}
...
class UTDPersonnel extends Uent {
   ...
   */
  async reload() {
    Object.assign(this, (await getInst().loadUTDInfo(this.uid)));
...
class Student extends Uent {
   ...
   */
  async reload() {
    Object.assign(this, await getInst().loadStudentInfo(this.uid));
  }
}
...
class Faculty extends Uent {
   ...
   */
  async reload() {
    Object.assign(this, await getInst().loadFacultyInfo(this.uid));
  }
}
