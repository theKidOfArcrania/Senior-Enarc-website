...
/**
 * Tries to run a function and its arguments, and if an error occurs, we return
 * null. The asynchronous version.
 * @param {Function} fn    the function
 * @param {Object[]} args  the arguments passed to the function
 * @return {Any} the value of the function, or null if it fails
 */
async function anice(fn, ...args) {
  try {
